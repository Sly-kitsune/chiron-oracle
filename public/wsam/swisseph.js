    ...
    return (function (moduleArg = {}) {
        ...
        async function createWasm() {
            function receiveInstance(instance, module) {
                ...
                console.log('DEBUG: Raw wasmExports keys:', Object.keys(wasmExports));

                // Robustly map exports to Module to handle underscore prefix mismatch
                for (let key in wasmExports) {
                    Module[key] = wasmExports[key];
                    if (key.startsWith('_')) {
                        Module[key.substring(1)] = wasmExports[key];
                    } else {
                        Module['_' + key] = wasmExports[key];
                    }
                }

                console.log('DEBUG: Module keys after mapping:', Object.keys(Module));
                return Module;
            }
        ...
        var getCFunc = ident => {
            ...
            console.log('DEBUG: getCFunc looking for:', ident, ' as ', "_" + ident, ' found:', typeof func);
            return func
        }
            ;
